...
const { createBrand, getBrands } = require("./brands.service");
const { createModel, getModelsByBrandId } = require("./models.service");
const { getUsers, addUserDetails, getDetailsById } = require("./users.srevice");
...
app.get("/brands/:id", getModelsByBrandId);
